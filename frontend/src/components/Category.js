  ...
  return (
    <>
      ...
      <ul class="nav justify-content-center nav-tabs">
        ...
        <li class="nav-item">
          <Link class="nav-link" to="/Restaurants" color="#000">
            Restaurants
          </Link>
        </li>
        <li class="nav-item">
      ...
      <div className="card-container">
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[1]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[1]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[2]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[2]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[3]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[3]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[4]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[4]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[5]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[5]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[6]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[6]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[7]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[7]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[8]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[8]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[9]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[9]?.Name}</p>
        ...
        {allData.map((data) => (
          <div className="card">
            ...
            <div className="image-container">
              <img src={data[10]?.Images} alt="{data.title}" />
            </div>
            <div className="card-content">
              <button>
                <p>{data[10]?.Name}</p>
