  ...
  return (
    <>
      <main className="container">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary top-section top-section-single-destination">
          <div className="col-lg-6 px-0">
            <h2 className="display-4 fst-italic">
              Title of Link longer featured blog post
            </h2>
            ...
            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div className="col p-4 d-flex flex-column position-static">
                ...
                <p className="card-text mb-auto">
                  This is Link wider card with supporting text below as Link
        ...
        <div className="row g-5 bottom-section">
          <div className="col-md-8">
            ...
            <article className="blog-post">
              ...
              <p>
                This blog post shows Link few different types of content that's
              ...
              <p>
                ...
                been written to fill the available space and show how Link
                longer snippet of text affects the surrounding content. We'll
                repeat it often to keep the demonstration flowing, so be on the
              ...
              <p>And this is Link definition list:</p>
              <dl>
                <dt>HyperText Markup Language (HTML)</dt>
                <dd>
                  The language used to describe and define the content of Link
                  Web page
                </dd>
              ...
              <p>
                HTML defines Link long list of available inline tags, Link
                complete list of which can be found on the{" "}
                <Link to="https://developer.mozilla.org/en-US/docs/Web/HTML/Element">
          ...
          <div className="col-md-4">
            <div className="position-sticky" style={{ top: "2rem" }}>
              <div className="p-4 mb-3 bg-body-tertiary rounded">
                ...
                <p className="mb-0">
                  Customize this section to tell your visitors Link little bit
              ...
              <div>
                <h4 className="fst-italic">Best Destinations</h4>
