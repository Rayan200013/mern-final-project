          ...
          <div className="mission-content">
            ...
            <div className="text-container">
              ...
              <p>
                ...
                the joy of exploration in CHOUF. Because we believe this builds
                a kinder, more inclusive, more open-minded world.
              </p>
              <p>
              ...
              <p>
                ...
                offer. And we have learned that the best travel is about putting
      ...
      <section className="team-section">
        ...
        <div className="story-container">
          <div className="story-content">
            ...
            <p>
              After spending months navigating the corporate world, the decision
              was clear — to follow our hearts and create our very own travel
              company. We envisioned a business that would extend the same joy
              and sense of wonder we experienced to others.
            </p>
            <p>
              ...
              did. At our core, we're travelers who want to share the thrill of
              discovering new horizons, forging connections, and embracing the
              unknown.
            </p>
          </div>
